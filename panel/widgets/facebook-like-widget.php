...
class Facebook_Like_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		if($page_url): ?>
		<div class="facebook-like-wrap"><h3 class="widget-title"><span>Facebook Page</span></h3>
	...
	{
		$defaults = array( 'page_url' => '', 'width' => '300', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
